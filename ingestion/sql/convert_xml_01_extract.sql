...
-- @SCHEMA_HASH_FILES sql/convert_xml_01_extract.sql sql/convert_xml_01b_heal_cascade.sql sql/convert_xml_01c_design_function_retype.sql sql/convert_xml_01d_display_calc_promote.sql sql/convert_xml_02_resolve.sql sql/convert_xml_03_details.sql sql/convert_xml_04_catalog.sql
*/
...
-- Ein Parse des DDR-Calculation-Zweigs, materialisiert (TEMP) und von allen
-- Konsumenten dieses Blocks genutzt (DDR_Calculations, DDR_ChunkListContexts,
-- Staging saxml23) — vorher lasen DDR_Calculations und DDR_ChunkListContexts
-- den Zweig je einmal (zwei Whole-Doc-Parses). Ergebnis bit-identisch.
