-- Unknown error-code literal: numeric literals compared with Get(LastError)
-- that no row of the FileMaker error-code table covers (ranges included: 5123 is covered by 5000-5499).
