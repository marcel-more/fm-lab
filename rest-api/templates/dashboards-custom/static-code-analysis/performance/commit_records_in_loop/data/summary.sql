-- Hand-maintained COUNT wrapper embedding the findings core of rule (commit_records_in_loop).
...
SELECT
    ...
    'Commit Records/Requests at step ' || (Step_Index + 1) || ' runs inside a loop (depth '
