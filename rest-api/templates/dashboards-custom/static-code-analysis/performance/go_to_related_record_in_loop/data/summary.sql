-- Hand-maintained COUNT wrapper embedding the findings core of rule (go_to_related_record_in_loop).
...
SELECT
    ...
    'Go to Related Record at step ' || (Step_Index + 1) || ' runs inside a loop (depth '
...
WHERE Step_ID = 74 AND loop_depth_before >= 1
